...
internal class BaseAttack : MonoBehaviour {
    ...
    [SerializeField, Range(0, 100)] protected float _baseStaminaConsumption = default;
    ...
    protected PlayerStamina _stamina = default;

    public void Initialization(in Transform playerPosition, in PlayerDirection direction, in PlayerAttackFactor attackFactor, in PlayerStamina stamina) {
