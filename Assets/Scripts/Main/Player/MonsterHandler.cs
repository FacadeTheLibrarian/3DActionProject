...
internal sealed class MonsterHandler : IDisposable {
    ...
    private readonly ReactiveProperty<MonsterHandler.e_generation> GENERATION = new ReactiveProperty<MonsterHandler.e_generation>(MonsterHandler.e_generation.first);
    ...
    public void SummonMonsters(in MonsterSetData monsterData, in Transform parent) {
