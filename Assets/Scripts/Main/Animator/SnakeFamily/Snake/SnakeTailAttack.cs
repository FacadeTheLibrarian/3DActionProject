...
internal sealed class SnakeTailAttack : BaseOnAttackAction {
    protected override void OnEnterAttack(float clipLength) {
        ...
        Collider[] results = ComponentExtension.BoxOverlap(playerTransform, castPosition, new Vector3(2.5f, 1.0f, 5.0f), playerTransform.rotation, _attackCastVariables.GetLayerMask, true);
